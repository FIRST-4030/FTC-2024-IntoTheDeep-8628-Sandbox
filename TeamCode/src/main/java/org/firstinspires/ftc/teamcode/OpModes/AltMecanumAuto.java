...
@Config
@Autonomous(name = "AltMecanumAuto")
public final class AltMecanumAuto extends LinearOpMode {
...
//        tickLimit = maxVal;
        ...
        AltMecanumDrive drive = new AltMecanumDrive(hardwareMap, startPose.toPose2d());
...
//                        .splineToConstantHeading(new Vector2d(PLACEONE_X, PLACEONE_Y), Math.toRadians(-90.0), baseVelConstraint,baseAccelConstraint)
    ...
    public void outputLog (AltMecanumDrive drive){
