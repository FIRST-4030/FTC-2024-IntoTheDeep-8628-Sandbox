...
@Disabled
@Config
@TeleOp(name = "AltSplineTest")
public final class AltSplineTest extends LinearOpMode {
    @Override
...
//        AccelConstraint baseAccelConstraint = new ProfileAccelConstraint(-30.0, 100.0);
        ...
        if (AltTuningOpModes.DRIVE_CLASS.equals(AltMecanumDrive.class)) {
...
//                        .build()
        ...
        } else if (AltTuningOpModes.DRIVE_CLASS.equals(TankDrive.class)) {
