...
import org.firstinspires.ftc.teamcode.AltThreeDeadWheelLocalizer;
...
public final class AltTuningOpModes {
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(AltMecanumDrive.class)) {
            dvf = hardwareMap -> {
                ...
                } else if (md.localizer instanceof AltThreeDeadWheelLocalizer) {
